...
using LukOilMVP.Data;
using LukOilMVP.Models;
using LukOilMVP.Views;


namespace LukOilMVP.Presenters
{
    public class MainViewPresenter
    {
        ...
        private void ViewLitrRadioButtonCheckedChanged(object sender, EventArgs e)
        {
            if (_view.LitrRadioButton.Checked)
            {
                SetDefaultValuesForsso2Vu8Ke6GEY5W51wwPPMqKZJowXQCeaed(_view.PriceNumericUpDown);
        ...
        private void SetDefaultValuesForsso2Vu8Ke6GEY5W51wwPPMqKZJowXQCeaed(Guna.UI2.WinForms.Guna2NumericUpDown numericUpDown)
        {
        ...
        private void ViewPriceRadioButtonCheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                SetDefaultValuesForsso2Vu8Ke6GEY5W51wwPPMqKZJowXQCeaed(_view.LitrNumericUpDown);
